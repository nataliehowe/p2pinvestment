                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-row text-left preview-form">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group mt-2">
                                <label class="golden-text"><strong>Wallet Gateway</strong></label>
                                @if(isset($wallet_gateway_1) || isset($wallet_gateway_2))
                                <select class="form-select" name="selected_gateway">
                                    <option selected value="{{$wallet_gateway_1}} : {{$wallet_address_1}}">{{$wallet_gateway_1}}</option>
                                    <option value="{{$wallet_gateway_2}} : {{$wallet_address_2}}">{{$wallet_gateway_2}}</option>
                                </select>
                                @else
                                GO and set gateway
                            @endif
                        ...
                        <div class="col-md-12">
                            ...
                            @else
                                Set Payout Gateway in  <a href="{{ route('user.profile') }}">Profile</a>
                            @endif
                        </div>
