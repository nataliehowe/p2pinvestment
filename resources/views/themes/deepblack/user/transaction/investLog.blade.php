                        ...
                        <table class="table table-striped mb-5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button data-plan-id="{{optional(@$invest->plan)->id}}"  data-amount="{{getAmount($invest->amount)}}" data-balance_type="balance" id="reInvestBtn"  class="reInvestBtn btn btn-success btn-sm" type="button">Re-invest</button>
                                    </td>
                                </tr>
                                @empty
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <script>        
        ...
        $(document).on('click', '.reInvestBtn', function (e) {
                ...
                var balance_type = $(this).data("balance_type");
