                    ...
                    <div id="tab1" class="content {{ $errors->has('profile') ? ' active' : (($errors->has('password') || $errors->has('identity') || $errors->has('addressVerification')) ? '' :  ' active') }}">
                        ...
                        <form action="{{ route('user.updateInformation')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="wallet_gateway_1" class="golden-text">@lang('wallet gateway 1')</label>
                                    <input type="text" id="wallet_gateway_1"name="wallet_gateway_1"class="form-control" value="{{old('wallet_gateway_1')?: $user->wallet_gateway_1 }}" placeholder="btc, usdt, etc" required />
                                    @if($errors->has('wallet_gateway_1'))
                                        <div class="error text-danger">@lang($errors->first('wallet_gateway_1'))</div>
                                    @endif
                                </div>

                                <div class="col-md-6 mb-4">
                                    <label for="wallet_address_1" class="golden-text">@lang('wallet address 1')</label>
                                    <input type="text" id="wallet_address_1"name="wallet_address_1"class="form-control" value="{{old('wallet_address_1')?: $user->wallet_address_1 }}" required/>
                                    @if($errors->has('wallet_address_1'))
                                        <div class="error text-danger">@lang($errors->first('wallet_address_1'))</div>
                                    @endif
                                </div>

                                <div class="col-md-6 mb-4">
                                    <label for="wallet_gateway_2" class="golden-text">@lang('wallet gateway 2')</label>
                                    <input type="text" id="wallet_gateway_2"name="wallet_gateway_2" class="form-control" value="{{old('wallet_gateway_2')?: $user->wallet_gateway_2 }}" placeholder="btc, usdt, etc" required/>
                                    @if($errors->has('wallet_gateway_2'))
                                        <div class="error text-danger">@lang($errors->first('wallet_gateway_2'))</div>
                                    @endif
                                </div>

                                <div class="col-md-6 mb-4">
                                    <label for="wallet_address_2" class="golden-text">@lang('wallet address 2')</label>
                                    <input type="text" id="wallet_address_2"name="wallet_address_2"class="form-control" value="{{old('wallet_address_2')?: $user->wallet_address_2 }}" required/>
                                    @if($errors->has('wallet_address_2'))
                                        <div class="error text-danger">@lang($errors->first('wallet_address_2'))</div>
                                    @endif
                                </div>
