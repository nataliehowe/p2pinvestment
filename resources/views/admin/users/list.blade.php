            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col">@lang('Verify code')</th>
                    ...
                    @forelse($users as $user)
                        <tr>
                            ...
                            <td data-label="@lang('verify code')">{{$user->verify_code}}</td>
    ...
    <div class="modal fade" id="all_delete" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>@lang("Are you really want to Delete the User's")</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal"><span>@lang('No')</span></button>
                    <form action="" method="post">
        ...
        "use strict";
            ...
            $(document).on('click', '.delete-yes', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.user-multiple-delete') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
