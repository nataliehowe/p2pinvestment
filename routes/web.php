...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin','permission']], function () {
        ...
        Route::post('/investments-delete', 'Admin\LogController@investmentsDelete')->name('investments-delete');
        ...
        Route::post('/users-delete', 'Admin\UsersController@deleteMultiple')->name('user-multiple-delete');
        ...
        Route::get('/user/send-proof', 'Admin\UsersController@sendProof')->name('send-proof');


        Route::post('/user/send-email/{id}', 'Admin\UsersController@sendMailUser')->name('user.email-send');
        Route::post('/user/send-proof/', 'Admin\UsersController@sendProofUser')->name('user.proof-send');
...
// Define routes for the pages with "pifi-" or "pifi" added
Route::get('/thank-you', 'FrontendController@pifiThankYou')->name('thank-you');
Route::get('/verification-error', 'FrontendController@pifiVerificationError')->name('verification-error');

Route::get('/pifi-about', 'FrontendController@pifiAbout')->name('pifi-about');
Route::get('/pifi-confirmation', 'FrontendController@pifiConfirmation')->name('pifi-confirmation');
Route::get('/pifi-financial-reports', 'FrontendController@pifiFinancialReports')->name('pifi-financial-reports');
Route::get('/pifi-loans', 'FrontendController@pifiLoans')->name('pifi-loans');
Route::get('/pifi-save', 'FrontendController@pifiSave')->name('pifi-save');
Route::get('/pifi-blog', 'FrontendController@pifiBlog')->name('pifi-blog');
Route::get('/pifi-investing', 'FrontendController@pifiInvesting')->name('pifi-investing');
Route::get('/pifi-market', 'FrontendController@pifiMarket')->name('pifi-market');
Route::get('/pifi-refer-a-friend', 'FrontendController@pifiReferAFriend')->name('pifi-refer-a-friend');
Route::get('/pifi-contact-us', 'FrontendController@pifiContactUs')->name('pifi-contact-us');
Route::get('/pifi-invest-with-pifi', 'FrontendController@pifiInvestWithPifi')->name('pifi-invest-with-pifi');
Route::get('/pifi-originators-partnership', 'FrontendController@pifiOriginatorsPartnership')->name('pifi-originators-partnership');
Route::get('/pifi-statistics', 'FrontendController@pifiStatistics')->name('pifi-statistics');
Route::get('/pifi-faq', 'FrontendController@pifiFaq')->name('pifi-faq');
Route::get('/pifi-loan-originators', 'FrontendController@pifiLoanOriginators')->name('pifi-loan-originators');
Route::get('/pifi-clubs', 'FrontendController@pifiClubs')->name('pifi-clubs');

Route::get('/pifi-user-terms', 'FrontendController@pifiUserTerms')->name('pifi-user-terms');
Route::get('/pifi-privacy-policy', 'FrontendController@pifiPrivacyPolicy')->name('pifi-privacy-policy');
Route::get('/pifi-assignment-agreement', 'FrontendController@pifiAssignmentAgreement')->name('pifi-assignment-agreement');


Route::get('/pifi-cookie-policy', 'FrontendController@pifiCookiePolicy')->name('pifi-cookie-policy');
Route::get('/pifi-sitemap', 'FrontendController@pifiSitemap')->name('pifi-sitemap');


Route::get('/verify/email/{token}', 'FrontendController@verifyPifiEmail')->name('verify.email');


Route::get('/pifi-dashboard', 'FrontendController@pifiUser')->name('pifi-user');
