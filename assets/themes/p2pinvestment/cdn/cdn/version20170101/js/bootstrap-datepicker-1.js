    ...
    Datepicker.prototype = {
        ...
        _buildEvents: function() {
            ...
            if (this.isInput) {
                ...
                this._events = [ [ this.element.find("input"), events ], [ this.component, {
        ...
        place: function() {
            if (this.isInline) return this;
            var calendarWidth = this.picker.outerWidth(), calendarHeight = this.picker.outerHeight(), visualPadding = 10, container = $(this.o.container), windowWidth = container.width(), windowHeight = container.height(), scrollTop = container.scrollTop(), appendOffset = container.offset();
            var parentsZindex = [];
        ...
        getClassNames: function(date) {
            ...
            if (date.valueOf() < this.o.startDate || date.valueOf() > this.o.endDate || $.inArray(date.getUTCDay(), this.o.daysOfWeekHighlighted) !== -1) {
        ...
        fill: function() {
            ...
            this.picker.find(".datepicker-days thead .datepicker-switch").text(dates[this.o.language].months[month] + " " + (this.o.maxViewMode < 2 ? "" : year));
            ...
            var months = this.picker.find(".datepicker-months").find("th:eq(1)").text(this.o.maxViewMode < 2 ? "Months" : year).end().find("span").removeClass("active");
