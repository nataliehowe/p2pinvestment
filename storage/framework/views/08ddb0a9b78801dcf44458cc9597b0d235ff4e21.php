                ...
                <?php if(adminAccessRoute(config('role.payment_log.access.view'))): ?>
                    <li class="sidebar-item <?php echo e(menuActive(['admin.payment.pending'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.payment.pending')); ?>" aria-expanded="false">
                            ...
                            <?php if(isset($paymentRequestCount)): ?>                                                                
                                <span style="color: red;" class="hide-menu"><?php echo app('translator')->get('Deposit Request'); ?>
                                <?php echo e($paymentRequestCount); ?>
                    ...
                    <li class="sidebar-item <?php echo e(menuActive(['admin.payment.log','admin.payment.search'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.send-proof')); ?>" aria-expanded="false">
                        <i class="fas fa-envelope-open"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Generate proof'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                    ...
                    <li class="sidebar-item <?php echo e(menuActive(['admin.payout-request'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.payout-request')); ?>" aria-expanded="false">
                            <i class="fas fa-hand-holding-usd text-warning"></i>
                                ...
                                <?php if(isset($payoutRequestCount)): ?>                            
                                    <span style="color: red;" class="hide-menu"><?php echo app('translator')->get('Payout Request'); ?>                            
                                        <?php echo e($payoutRequestCount); ?>
...
<?php /**PATH /home/claifmyn/pifi-group.biz/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>