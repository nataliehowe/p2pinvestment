...
class HomeController extends Controller
{
    ...
    public function updateInformation(Request $request)
    {
        ...
        $user->wallet_gateway_1 = $req['wallet_gateway_1'];
        $user->wallet_address_1 = $req['wallet_address_1'];

        $user->wallet_gateway_2 = $req['wallet_gateway_2'];
        $user->wallet_address_2 = $req['wallet_address_2'];
    ...
    public function payoutPreview()
    {
        ...
        $wallet_gateway_1 = auth()->user()->wallet_gateway_1;
        $wallet_address_1 = auth()->user()->wallet_address_1;

        $wallet_gateway_2 = auth()->user()->wallet_gateway_2;
        $wallet_address_2 = auth()->user()->wallet_address_2;
        
        return view($this->theme . 'user.payout.preview', compact('withdraw', 'title', 'remaining', 'wallet_gateway_1', 'wallet_gateway_2', 'wallet_address_1', 'wallet_address_2'));
    }
    ...
    public function payoutRequestSubmit(Request $request)
    {
        ...
        $user = $this->user;
        $selectedGateway = $request->input('selected_gateway');
        ...
        if (getAmount($withdraw->net_amount) > $user[$withdraw->balance_type]) {
            ...
            if ($withdraw->method->input_form != null) {
                ...
                $withdraw['information'] = $selectedGateway;
            }
